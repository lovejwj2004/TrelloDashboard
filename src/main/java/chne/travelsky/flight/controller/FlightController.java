...
public class FlightController {
    ...
    @ResponseBody List<Flight> getFlightList(@PathVariable String od,@PathVariable String date){
    ...
    @ResponseBody Set<String> getAirlines(@PathVariable String od, @PathVariable String date){
